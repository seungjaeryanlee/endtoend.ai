...
The core concept of Random Network Distillation (RND) is fairly simple, but the paper has many additional "tricks", so it will take several weeks and iterations to implement it.  My next post will be implementing the very core idea of RND, and in the later posts I will gradually add more "tricks".
