...
The bewildering part is that absolute independence does not imply conditional independence. Suppose that we have two dice and we roll each once. The outcome of two dice are independent. However, if the die rolled a 1, and someone tells us that the sum of two dice is event, then the second die must have rolled odd. Thus, the outcome of two dice are independent but not conditionally independent.
