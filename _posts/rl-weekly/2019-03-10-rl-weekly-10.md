...
meta_image: /assets/blog/rl-weekly/10/lfp.png
front_image_type: contain
front_text: "In this issue, we look at Google Brain's algorithm of learning by playing, DeepMind's thoughts on multi-agent intelligence, and DeepMind's new navigation environment using Google Street View data."
