...
<div class="mdl-grid">
  <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-desktop mdl-cell--12-col-phone">
    <img src="{{absolute_url}}/assets/blog/ctrl/nfq/pole-balancing.gif" alt="Pole Balancing"/>
  </div>
  <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-desktopmdl-cell--12-col-phone">
    <img src="{{absolute_url}}/assets/blog/ctrl/nfq/mountain-car.gif" alt="Mountain Car"/>
  </div>
  <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-desktop mdl-cell--12-col-phone">
    <img src="{{absolute_url}}/assets/blog/ctrl/nfq/cartpole.gif" alt="CartPole"/>
  </div>
</div>
...
(For more details, please read Section 9.2 of *Least-Squares Policy Iteration* by Lagoudakis and Parr (2003))
